          ...
          child: Column(
            ...
            children: [
              ...
              const FittedBox(
                fit: BoxFit.fitWidth,
                child: Text(
                  'Vietnamese Traditional Cake Classify App',
                  style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
                    color: Color.fromARGB(255, 74, 32, 146),
                    ...
                    showDialog(
                      ...
                      builder: (context) {
                        return AlertDialog(
                          ...
                          content: const Text(
                              '1. Click on the "Upload Photo" button to upload a photo of a Vietnamese traditional cake.\n\n2. The app will classify the cake and show the result.\n\n(VTCC can only recognize names of traditional Vietnamese cakes, not other objects like tables, chairs, etc.)'),
                          actions: [
                            TextButton(
                              onPressed: () {
